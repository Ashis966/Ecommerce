                    ...
                    <ul class="list-group accordion" id="sideNavDropdown">
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="collapseOne" class="accordion-collapse collapse nav flex-column"
                                ...
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#" data-bs-toggle="tab"
                                        data-bs-target="#dextop_banner" role="tab">Add Dextop Banner</a>
                                </li>
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#" data-bs-toggle="tab"
                                        data-bs-target="#mobile_banner" role="tab">Add Mobile Banner</a>
                                </li>
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#" data-bs-toggle="tab"
                                        data-bs-target="#testimonials_banar" role="tab">Add testimonials</a></li>
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#" data-bs-toggle="tab"
                                        data-bs-target="#location_banner" role="tab">Add location</a></li>
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#" data-bs-toggle="tab"
                                        data-bs-target="#Offer_banar" role="tab">Add Offer Banner</a></li>
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#" data-bs-toggle="tab"
                                        data-bs-target="#Video_banar" role="tab">Add Video</a></li>
                            </ul>
                        </li>
                        <li class="nav-item ">
                        ...
                        <li class="nav-item">
                            ...
                            <ul id="collapseThree" class="accordion-collapse collapse nav flex-column"
                                ...
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="main_catagory.php">Add Category</a></li>
                                ...
                                <li class="nav-item droupdownCnt"><a class="nav-link" href="#">Add Product Extra
                                        Image</a></li>
