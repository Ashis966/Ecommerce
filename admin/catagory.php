                  ...
                  <div class="panel-primary">
                     ...
                     <div class="panel-body">
                        ...
                        if (!empty($_REQUEST['edit'])) {
                           ...
                           $edit = $db->query("SELECT * FROM `product_categorys` WHERE pc_id = '$edit_id'");
                           $edit_value = $edit->fetch_object();

                           $name = $edit_value->pc_name;
                           $description = $edit_value->pc_description;
                        ...
                        <form action="action/manage_catagory.php" method="POST" enctype="multipart/form-data">
                           <div class="form-grp">
                              ...
                              <input type="text" class="form-control" name="name" value="<?= $name; ?>" id="name" placeholder="Nmae">
                           </div>
                           <div class="form-grp">
                              <label for="image" class="form-label">Upload Image <span class="text-danger">1000 *
                                    1000</span></label>
                              <input class="form-control" type="file" id="upld_image" name="upld_image" accept="image/*">
                           </div>
                           <div class="form-grp">
                              <label for="" class="form-label">Description</label><br>
                              <textarea name="description" id="description" class=" chck-reset"><?= $description; ?></textarea>
                           </div>
                           <?php
                           if (!empty($_REQUEST['edit'])) {
                           ?>
                                 ...
                                 <div class="col-md-12">
                                    <div class="table-responsive">
                                       <table class="table table-bordered table-striped" style="width:100%">
                                          ...
                                          <tbody>
                                             <?php
                                             $data = $db->query("SELECT * FROM `product_categorys`");
                                             if ($data->num_rows == 0) {
                                                echo 'No Data Found';
                                             } else {
                                                $sl = 0;
                                             ...
                                             ?>
                                                   <tr>
                                                      ...
                                                      <td>
                                                         ...
                                                         <a href="action/manage_catagory.php?submit=delete&pc_id=<?= $value->pc_id; ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                                      </td>
                                                      <td><?= $value->pc_name; ?></td>
                                                      <td><?= $value->pc_description; ?></td>
                                                      <td>
                                                         <?php
                                                         ...
                                                         ?>
                                                            <img src="uploads/<?= $value->pc_image; ?>" class="img-fluid" width="100" alt="">
                                                         <?php } ?>
                                                      </td>
